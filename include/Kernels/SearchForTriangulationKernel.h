...
private:
    ...
    MAPPING_DATA_WRAPPER::CudaCamera d_currFrameCamera1, d_currFrameCamera2, *d_neighFramesCamera1, *d_neighFramesCamera2;
    Eigen::Vector2f *d_ep;

    size_t *d_matchedPairIndexes;
};
